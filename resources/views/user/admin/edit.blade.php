        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model($admin, ['route' => ['user.admins.update', $admin->id], 'method' => 'put', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::email('email', $admin->user->email, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('name', $admin->user->name, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('surname', $admin->user->surname, ['class' => 'form-control']) !!}
                        </div>
                    </div>
